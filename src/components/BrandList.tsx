       ...
       >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <h3 className={`font-bold text-sm ${theme.textMain}`}>Protein Brands Sold in Ethiopia</h3>
              <p className={`text-xs ${theme.textMuted}`}>Click to view safety details for Gold Standard, Ensure, etc.</p>
            </div>
          </div>
